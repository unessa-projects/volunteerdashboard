      ...
      >
        <div className="flex items-start">
          ...
          <div>
            ...
            <motion.button
              className="mt-6 px-8 py-3 bg-[#ECA90E] text-white rounded-full font-medium text-lg sm:text-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
              whileHover={{
                scale: 1.05,
