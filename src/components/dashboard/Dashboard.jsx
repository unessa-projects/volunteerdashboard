...
const Dashboard = () => {
  ...
  const socialLinks = [
    {
      platform: "whatsapp",
      handle: "+91 63631 98779",
      url: "https://wa.me/916363198779",
      icon: (
    ...
    {
      platform: "instagram",
      handle: "@unessafoundation",
      url: "https://www.instagram.com/unessafoundation/",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
    ...
    },
    {
      platform: "linkedin",
      handle: "Follow Us",
      url: "https://www.linkedin.com/company/unessafoundation/",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
          {socialLinks.map((social, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${social.color} text-white rounded-xl p-4 w-full sm:w-[calc(50%-1rem)] md:w-[calc(33.333%-1.5rem)] 
                         flex flex-col items-center justify-center transition-transform hover:scale-105 hover:shadow-lg`}
            >
              <div className="mb-2">
                {social.icon}
              </div>
              <span className="font-semibold text-sm md:text-base capitalize">{social.platform}</span>
              <span className="text-xs text-white/80 mt-1">{social.handle}</span>
            </a>
          ))}
        </div>
      </section>
