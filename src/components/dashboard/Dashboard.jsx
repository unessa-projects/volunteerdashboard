...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#001F3F] to-[#003366] p-4 md:p-8">
      ...
      <section className="my-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6 my-8 px-4">
  {/* WhatsApp Card */}
  <a
    href="https://wa.me/916363198779"
    target="_blank"
    rel="noopener noreferrer"
    className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-4 text-white bg-[#25D366] rounded-2xl shadow-md flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
  >
  ...
  <a
    ...
    className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-4 text-white bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-md flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
  >
    <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center mb-3">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-4 text-white bg-[#0077B5] rounded-2xl shadow-md flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
  >
    <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center mb-3">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
    ...
    <span className="text-xs md:text-sm text-white/80 mt-1 text-center">Follow Us</span>
  </a>
</div>
      </section>
    </div>
