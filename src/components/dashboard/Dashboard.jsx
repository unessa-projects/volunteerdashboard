...
<div data-tour-id="tour-impact">
  ...
  <div className="flex flex-col sm:flex-row justify-center items-center gap-6 md:gap-8 my-8 px-4">
    {/* WhatsApp Card */}
    <a
      href="https://wa.me/916363198779"
      target="_blank"
      rel="noopener noreferrer"
      className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-6 text-white bg-[#25D366] rounded-2xl shadow-md flex flex-col items-center justify-center transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
    >
      {/* WhatsApp Icon styled like app icon */}
      <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center mb-4 bg-white rounded-full">
        <svg
      ...
      <span className="font-semibold text-base md:text-lg text-center">WhatsApp Us</span>
      <span className="text-xs md:text-sm text-white/80 mt-1 text-center">+91 63631 98779</span>
    </a>
    ...
    <a
      ...
      className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-6 text-white bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-md flex flex-col items-center justify-center transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
    >
      <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center mb-4 bg-white rounded-full">
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <span className="font-semibold text-base md:text-lg text-center">Instagram</span>
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="cursor-pointer w-full sm:w-auto md:w-[200px] h-[200px] p-6 text-white bg-[#0077B5] rounded-2xl shadow-md flex flex-col items-center justify-center transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:z-10 hover:border-2 hover:border-white"
    >
      <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center mb-4 bg-white rounded-full">
        <svg
          xmlns="http://www.w3.org/2000/svg"
