...
const ImpactCalculator = () => {
  ...
  const fetchAndAnimate = async () => {
    try {
      ...
      if (!username) {
        ...
        if (email) {
          const userRes = await axios.get(`https://internapi.unessafoundation.org/api/users/${email}`);
      ...
      const res = await axios.get("https://internapi.unessafoundation.org/api/donations", {
        params: { username }
      });
  ...
  useEffect(() => {
    ...
    const socket = ioClient("https://internapi.unessafoundation.org/");
  ...
  const handleCopyLink = () => {
    const baseURL = "https://intern.unessafoundation.org/form";
