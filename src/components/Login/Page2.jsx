...
const Page2 = () => {
  ...
  return (
    <div className="min-h-screen  bg-[#F4F9F8] bg-cover bg-center flex justify-center items-center relative px-4">
  {/* Logo */}
  ...
  {/* Main Content */}
  <div className="bg-transparent border-none shadow-none p-6 sm:p-10 md:p-12 lg:p-14 w-full max-w-4xl text-center space-y-6 sm:space-y-8 lg:space-y-10">
    ...
    <button
      className="bg-[#21B6A8] hover:bg-[#1ca496] text-[#333333] px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg md:text-xl font-semibold transition duration-300 drop-shadow-lg"
      onClick={handleNext}
    >
      Boy, That’s Deep!
    </button>
