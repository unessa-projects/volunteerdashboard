...
const Number = () => {
 ...
 const handleSubmit = () => {
  ...
  return (
    <div className="h-screen  bg-[#F4F9F8] bg-cover bg-center flex justify-center items-center relative px-4">
  ...
  <div className="bg-transparent border-none shadow-none 
                  ...
                  text-center space-y-6 sm:space-y-8 md:space-y-10 
                  p-6 sm:p-8 md:p-10 lg:p-14 xl:p-16 mt-32">
